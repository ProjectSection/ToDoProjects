...
function App() {
  ...
  useEffect(() => {
    axios.get('http://todoprojects-2aqw.onrender.com/api/tasks')
  ...
  const handleAddTask = () => {
    ...
    axios.post('http://todoprojects-2aqw.onrender.com/api/tasks', { title: newTask, completed: false })
      .then(response => {
  ...
  const handleDeleteTask = (id) => {
    axios.delete(`http://todoprojects-2aqw.onrender.com/api/tasks/${id}`)
      .then(() => {
  ...
  const handleSaveEdit = (id) => {
    ...
    axios.put(`http://todoprojects-2aqw.onrender.com/api/tasks/${id}`, { title: editText })
      .then(response => {
